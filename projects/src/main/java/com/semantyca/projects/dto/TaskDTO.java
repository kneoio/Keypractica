...
public record TaskDTO(UUID id, String regNumber, String body, String assignee, java.util.Map<LanguageCode, String> taskType, Project project, Task parent, ZonedDateTime startDate, ZonedDateTime targetDate, int status , int priority, List<RLSDTO> rls) implements IDTO {
